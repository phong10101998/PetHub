...
class HomeAdapter(private val mContext: Context, private val onClickListener: (String) -> Unit) :
    BaseAdapter<HomeAdapter.ItemViewHolder>(mContext) {
    ...
    inner class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun onBind() {
            ...
            itemView.setOnClickListener{onClickListener("hello")}
